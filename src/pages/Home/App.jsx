    ...
    <div id="app">
      ...
      <div className="body home">
        ...
        <section className="aboutMe" id="aboutMe">
          ...
          <p>Je m'apelle Mathis Boisson, j'ai 23 ans, et je suis actuellement la formation intégrateur de chez OpenClassRoom. <br/>
            Titulaire d'un bac STI2D SIN, je me suis dans un premier temp dirigé vers un BTS FED option Domotique que j'ai obtenu en 2022 aprés 2 années d'alternance. <br/>
            Le métier ne me convenant pas vraiment, je prend la décision, en 2023, de me réorienter vers un métier qui m'intéresse depuis mon adolescence : le dévellopement web. <br/>
            Je commence donc ma démarche en m'insrivant à pole emploi, qui me propose un contrat engagement jeune et me finance ma formation actuel.</p>
        </section>
        ...
        <section className="contactMe" id="contactMe">
          ...
          <form className="contactForm">
            <label className="formLabel">Sujet</label>
            <input type="text" className="subject formInput" id="subjectForm" onChange={(e) => setMailtoSubject(e.target.value)}/>
            <label className="formLabel">Votre message</label>
            <textarea className="message formInput" id="messageForm" onChange={(e) => setMailtoBody(e.target.value)}/>
            <a href={"mailto:math.boiss@laposte.net?subject=" + mailtoSubject + "&body=" + mailtoBody}>
